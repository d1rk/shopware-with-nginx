...
apt-get update
apt-get upgrade
apt-get install -y software-properties-common htop letsencrypt
...
# php
apt-get install -y php7.0 php7.0-gd php7.0-zip php7.0-xml php7.0-intl php7.0-mbstring php7.0-curl
